...
# We have to declare the base exporter extension here as glTF plugin only looks in __init__.py files for extensions. We inherit the functions of the actual exporter extension
