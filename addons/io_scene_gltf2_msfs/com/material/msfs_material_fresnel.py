...
class MSFS_Fresnel(MSFS_Material):

    def __init__(self, material):
        super(MSFS_Fresnel, self).__init__(material)
    ...
    def displayParams(self):
        ...
        self.material.msfs_show_fresnel_parameters = True
    ...
    def customShaderTree(self):
        super(MSFS_Fresnel, self).defaultShaderStree()