...
class MSFS_GeoDecal(MSFS_Material):

    def __init__(self, material):
        super(MSFS_GeoDecal, self).__init__(material)
    ...
    def displayParams(self):
        ...
        self.material.msfs_show_geo_decal_parameters = True
    ...
    def customShaderTree(self):
        super(MSFS_GeoDecal, self).defaultShaderStree()